...
if __name__ == '__main__':
    ...
    output_path = "./data/chain-of-thought_prepared.jsonl"
    api_key = "sk-"
    base_url = "https://api.siliconflow.cn/v1/chat/completions"
    after_api_path = "./data/chain-of-thought_aftgpt.jsonl"
    wrong_ans_path = "./data/chain-of-thought_wrong_ans.json"
    score_path = "./data/chain-of-thought_score.json"
