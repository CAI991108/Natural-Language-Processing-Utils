...
# 定义tree-of-thought prompting的提示模板
...
问题: {question}
选项: {option}
让我们一步一步地思考，并探索不同的解路径。
'''

def generate_query(data, examples, technique="tree-of-thought"):
    if technique == "tree-of-thought":
...
def prepare_data(input_path, output_path, technique="tree-of-thought"):
...
if __name__ == '__main__':
    ...
    output_path = "./data/tree-of-thought_prepared.jsonl"
    api_key = "sk-"
    base_url = "https://api.siliconflow.cn/v1/chat/completions"
    after_api_path = "./data/tree-of-thought_aftgpt.jsonl"
    wrong_ans_path = "./data/tree-of-thought_wrong_ans.json"
    score_path = "./data/tree-of-thought_score.json"
