...
def generate_query(data, examples, technique="few-shot"):
...
def prepare_data(input_path, output_path, technique="few-shot"):
...
if __name__ == '__main__':
    ...
    output_path = "./data/few-shot_prepared.jsonl"
    api_key = "sk-"
    base_url = "https://api.siliconflow.cn/v1/chat/completions"
    after_api_path = "./data/few-shot_aftgpt.jsonl"
    wrong_ans_path = "./data/few-shot_wrong_ans.json"
    score_path = "./data/few-shot_score.json"
    technique = "few-shot"
